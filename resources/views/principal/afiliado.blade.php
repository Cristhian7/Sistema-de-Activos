...
<head>
    ...
    <title>Gestión de Afiliados | Sistema de Activos</title>
    <style>
        * {
        ...
        <div class="grid-layout">
            ...
            <div class="card-form">
                ...
                <form action="{{ route('afiliados.store') }}" method="POST">
                    ...
                    <button type="submit" class="btn-save">Guardar Afiliado</button>
                </form>
            </div>

            <!-- Columna Derecha: Tabla -->
            <div class="card-table">
                <h3>Listado de Afiliados Registrados</h3>
                <table>
                    <thead>
                        <tr>
                            <th>ID</th>
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="2" style="text-align: center; color: #94a3b8;">No hay afiliados registrados.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
