...
<head>
    ...
    <title>Listado de Bajas - Sistema de Activos</title>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 tracking-tight">
                    Historial de Bajas Realizadas
                </h1>
                <p class="text-sm text-gray-500 mt-1">
                    Consulta general de desincorporaciones, traslados y estado final de los equipos de cómputo.
                </p>
            </div>
                ...
                <table class="w-full text-left text-sm border-collapse">
                    <thead>
                        <tr class="bg-gray-50 border-b border-gray-200 text-xs font-semibold text-gray-600 uppercase tracking-wider">
                            ...
                            <th scope="col" class="py-3.5 px-4">Años de Uso</th>
                            <th scope="col" class="py-3.5 px-4">Estado</th>
                            <th scope="col" class="py-3.5 px-4">CPU</th>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse($bajas as $baja)
                            <tr class="hover:bg-gray-50/80 transition-colors duration-150">
                                ...
                                <!-- Años de Uso -->
                                <td class="py-3.5 px-4 text-gray-600 whitespace-nowrap">
                                    {{ isset($baja->años_uso) ? number_format($baja->años_uso, 1) . ' años' : '-' }}
                                </td>
                                ...
                                <td class="py-3.5 px-4 text-center whitespace-nowrap">
                                    <a href="{{ route('baja.pdf', $baja->id_baja) }}" 
                                       target="_blank"
                                       class="bg-red-600 hover:bg-red-700 text-white font-medium text-xs px-3 py-1.5 rounded-md shadow-sm transition-colors duration-150 inline-flex items-center gap-1.5">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
